<template>
  <div class="card" role="button" tabindex="0">
    ...
    <div class="guild-info">
      <div class="title">
        <a-tooltip v-if="partner">
          <template #title>已验证 &amp; 已合作</template>
          <div class="flower-star-container guild-badge" :class="partner">
            ...
            <div class="child-container">
              <svg v-if="partner === 'verified'" class="icon" aria-hidden="false" width="16" height="16" viewBox="0 0 16 15.2">
                <path d="M7.4,11.17,4,8.62,5,7.26l2,1.53L10.64,4l1.36,1Z" fill="currentColor"></path>
              </svg>
              <svg v-if="partner === 'partnered'" class="icon" aria-hidden="false" width="16" height="16" viewBox="0 0 16 16">
