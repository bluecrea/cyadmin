<template>
  <header class="container-themed">
    <div class="children">
      <div class="icon-wrapper">
        <svg width="24" height="24" viewBox="0 0 24 24" class="icon-header-svg">
      ...
      <h3 class="title-base">{{ routeTitle }}</h3>
    </div>
    <div class="toolbar">
      <div class="icon-wrapper clickable">
        <a-tooltip placement="bottom">
          ...
          <svg x="0" y="0" class="icon-header-svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <div class="icon-wrapper clickable">
        <a-tooltip placement="bottom">
          ...
          <svg x="0" y="0" class="icon-header-svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path fill="currentColor" d="M18 9V14C18 15.657 19.344 17 21 17V18H3V17C4.656 17 6 15.657 6 14V9C6 5.686 8.686 3 12 3C15.314 3 18 5.686 18 9ZM11.9999 21C10.5239 21 9.24793 20.19 8.55493 19H15.4449C14.7519 20.19 13.4759 21 11.9999 21Z"></path>
          </svg>
        </a-tooltip>
      </div>
<!--      <div class="icon-wrapper clickable">
        <a-tooltip placement="bottom">
          ...
          <svg x="0" y="0" class="icon-header-svg" width="24" height="24" viewBox="0 0 24 24">
      ...
      <div class="icon-wrapper clickable">
        <a-tooltip placement="bottom">
          ...
          <img class="icon-header-svg" src="../../assets/images/partner.png" alt="">
        </a-tooltip>
      </div>
    </div>
  </header>
